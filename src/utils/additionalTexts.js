...
If you haven’t reached the end/haven’t read the previous story/etc, you can check the summary on this page: “World state” button will show you some general info on what’s going on, and “Who you are” will provide a brief recap of the events that took place before.
...
Each tower is a separate state while they are all ruled by the Builders Council. Its members developed and constructed them long ago. Their dynasties define humans' fate since then. They occupy the top level of the main lifescraper called the Pillar.

Not having enough space, jobs and money in the real world, humans spend most of the time in the virtual one. It’s a global network called zerOne, a digital representation of the tower you live in. It provides more space but is still restricted in terms of getting higher or lower. Your financial situation is the main factor that can remove some of the restrictions. Connections with other towers are blocked, although there are some ways to bypass this.
