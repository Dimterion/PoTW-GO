const gameContents = [
  ...
  },
  {
    ...
    “You are as real as you can ever be. Human, non-human, why should this matter? You say you can feel and that’s what matters.” - She sighs. - “It’s when you stop feeling, that’s when it becomes terrifying. Having no connection to the world around you is a scary thing, Soai. Try not to lose it.”

    She looks sad, thinking about something else, like being somewhere in a different place, far away. Then she shakes her head abruptly, smiles and continues in a cheerful voice.
    
    “Anywho, about this place. A while ago I managed to slip by the security systems and installed a camera right where we are right now.” - She giggles and winks at you. - “So, we’re kinda watching the online feed. I did some tweaking, cleared the image a bit and so on. Well, this metal piece is somewhat smaller in reality, but, what’s funny, it’s still there. Can you imagine, with all the work and planning, they forgot about it somewhere along the construction. I like to come here from time to time and watch what’s still there, beneath us. The remains of our old home, which is now no more than a foundation, slowly collapsing and fading away.”`,
    options: [
      {
        text: `Test option 3`,
        nextText: 3,
